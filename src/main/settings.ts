/**
 * 应用设置持久化 — ~/.yutianclaw/settings.json
 *
 * 存储 YuTianClaw 自身的设置（代理、主题等），
...
const SETTINGS_PATH = join(YUTIANCLAW_HOME, 'settings.json')
...
export function saveSettings(patch: Partial<AppSettings>): AppSettings {
  ...
  try {
    mkdirSync(YUTIANCLAW_HOME, { recursive: true })
