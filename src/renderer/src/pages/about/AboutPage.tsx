...
import { YUTIANCLAW_API_BASE_URL, YUTIANCLAW_DOCS_URL, YUTIANCLAW_WEBSITE_URL } from '@shared/urls'
...
export default function AboutPage(): React.ReactElement {
    ...
    const load = async (): Promise<void> => {
      try {
        const [aboutRes, channelsRes] = await Promise.allSettled([
          fetch(`${YUTIANCLAW_API_BASE_URL}/v1/about`, {
            headers: { Accept: 'application/json' },
          }),
          fetch(`${YUTIANCLAW_API_BASE_URL}/v1/channels`, {
            headers: { Accept: 'application/json' },
          }),
        ])
  ...
  const website = aboutPayload?.about?.website || YUTIANCLAW_WEBSITE_URL
  const docs = aboutPayload?.about?.docs || YUTIANCLAW_DOCS_URL
            ...
            <Row gutter={[8, 8]}>
              ...
              <Col>
                <Button
                  icon={<GithubOutlined />}
                  onClick={() =>
                    window.api.shell.openExternal('https://github.com/yutianclaw/yutianclaw')
                  }
                >
                  GitHub
                </Button>
              ...
              <Col>
                <Button
                  ...
                  onClick={() =>
                    window.api.shell.openExternal('https://atomgit.com/yutianclaw/yutianclaw')
                  }
                >
                  AtomGit
                </Button>
            ...
            <Row gutter={[8, 8]}>
              <Col>
                <Button
                  icon={<GithubOutlined />}
                  onClick={() =>
                    window.api.shell.openExternal('https://github.com/yutianclaw/yutianclaw/issues')
                  }
                >
                  GitHub Issues
                </Button>
              ...
              <Col>
                <Button
                  ...
                  onClick={() =>
                    window.api.shell.openExternal('https://atomgit.com/yutianclaw/yutianclaw/issues')
                  }
                >
                  AtomGit Issues
                </Button>
