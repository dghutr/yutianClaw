...
export default function SkillsPage(): React.ReactElement {
  ...
  const importMenuItems = [
    { key: 'directory', label: t('skills.importDirectory') },
    { key: 'zip', label: t('skills.importZip') },
  ]
          ...
          <Space>
            <Dropdown
              menu={{
                ...
                onClick: ({ key }) => void handleImportLocal(key as 'directory' | 'zip'),
              }}
            >
              <Button icon={<UploadOutlined />}>{t('skills.importLocal')}</Button>
            </Dropdown>
